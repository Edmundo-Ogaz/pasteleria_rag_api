from llm.prompts import prompt_ask_product, prompt, prompt_history_retrieval, prompt_history
...
class Groq:
    def __init__(self):
        self.__llm = ChatGroq( model="llama-3.3-70b-versatile", temperature=0.0, )
        ...
        history_aware_retriever = create_history_aware_retriever(self.__llm, chroma.get_retriever(), prompt_history_retrieval)
